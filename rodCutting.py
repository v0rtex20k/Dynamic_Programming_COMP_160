'''
Imagine you have n different items, each with a value and a length.
If what you currently have plus a new element has total length more
than n, don't include. Otherwise, throw it in the bag. 

At the same time, store each result in the table for future reference.
'''
